...
import { convertToPng, resizeImage } from "@oh-my-pi/pi-coding-agent/extensibility/legacy-pi-coding-agent-shim";
...
describe("legacy shim image conversion", () => {
	it("exports resizeImage for legacy package-root consumers", () => {
