...
/**
 * Upstream pi-ai exports `clampThinkingLevel(model, level)`; OMP's catalog
 * split renamed it to `clampThinkingLevelForModel`. Bridge the historical
 * name for legacy extensions.
 */
